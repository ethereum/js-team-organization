...
For the same reasons of our stack being quite modular and extensive, the EthereumJS libraries are well suited to do early-on research prototyping. In 2024 we have leveraged this by realizing an extensive prototype implementing a research snapshot around the work on a new SSZ-based transaction format ([EIP-6404](https://github.com/ethereum/EIPs/blob/master/EIPS/eip-6404.md)) as well as a corresponding signature scheme ([EIP-6493](https://github.com/ethereum/EIPs/blob/master/EIPS/eip-6493.md)) + additional SSZ-ification side EIPs.
